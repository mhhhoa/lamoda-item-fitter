...
class Settings:
    ...
    """Диапазон плавной дотяжки почти-белого.

    Нижний порог держится ВЫШЕ светлой кожи и белого реквизита: иначе дотяжка
    съедает их вместе с фоном. Понижать стоит только если фон упорно не выходит
    белым, и сразу смотреть в отчёте метрику «выбелено товара»."""
